...
async function loadPreviousSetup(){
  ...
  if(previousSetup.answerProvider){const saved=String(previousSetup.answerProvider);answerProvider.value=['openai','cerebras','hybrid'].includes(saved)?saved:'openai';}
